...
if __name__ == "__main__":
    ...
    estudiante1 = Estudiante("Andres", "Ramos", "Lopez", 22, "RU-1001", "MAT-A1")
    estudiante2 = Estudiante("Sofia", "Castro", "Vargas", 22, "RU-1002", "MAT-B2")
    ...
    print(f"\nVerificacion: Misma edad que {docente_ejemplo._nombre} (45)?")
    print(f"Andres (22) vs Laura (45): {verificar_misma_edad(estudiante1, docente_ejemplo)}")
    print(f"Sofia (23) vs Laura (45): {verificar_misma_edad(estudiante2, docente_ejemplo)}")
