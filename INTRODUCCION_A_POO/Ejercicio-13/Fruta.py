...
if __name__ == "__main__":
    ...
    mandarina = Fruta("mandarina", "citrica")
    mandarina.agregar_vitamina("C", True)
    mandarina.agregar_vitamina("A", False)

    manzana = Fruta("manzana", "comun", {"A": False})
    ...
    print(f"La fruta con mas vitaminas es: {fruta_max_vit.nombre} ({fruta_max_vit.nroVitaminas} vitaminas)")
    ...
    print("\n--- CONTEO DE CITRICAS ---")
    print(f"Total de vitaminas citricas en las frutas: {total_citricas}")
    ...
    print("\n---  FRUTAS ORDENADAS POR ALFABETICAMENTE POR SU PRIMERA VITAMINA ---")
