...
if __name__ == "__main__":
    persona1 = Persona("Ana", "Garcia", "Lopez", 25, "1234567")
    persona2 = Persona("Carlos", "Garcia", "Martinez", 16, "9876543")
    ...
    persona2.mostrar_datos()
    print(f"Nueva verificacion para {persona2.nombre}: {persona2.mayor_de_edad()}")

    print("\n4. Verificar mismo apellido paterno:")
    print( f"¿{persona1.nombre} y {persona2.nombre} tienen el mismo apellido paterno? {persona1.mismo_apellido_paterno(persona2)}")

    persona3 = Persona("Laura", "Perez", "Soto", 30, "1122334")
    print(
